...
**Current Version:** Claude Code 2.1.138 (Updated 2026-05-11)
...
**npm availability note (2026-05-11):** `@anthropic-ai/claude-code@2.1.43`, `2.1.46`, `2.1.57`, `2.1.60`, `2.1.65`, `2.1.102`, `2.1.103`, `2.1.106`, and `2.1.130` are not published on npm (`ETARGET`/`E404`). `2.1.64`, `2.1.66`, `2.1.67`, `2.1.68`, `2.1.69`, `2.1.70`, `2.1.71`, `2.1.72`, `2.1.73`, `2.1.74`, `2.1.75`, `2.1.76`, `2.1.77`, `2.1.78`, `2.1.79`, `2.1.80`, `2.1.81`, `2.1.83`, `2.1.84`, `2.1.85`, `2.1.86`, `2.1.87`, `2.1.88`, `2.1.89`, `2.1.90`, `2.1.91`, `2.1.92`, `2.1.94`, `2.1.96`, `2.1.97`, `2.1.98`, `2.1.101`, `2.1.104`, `2.1.105`, `2.1.107`, `2.1.108`, `2.1.109`, `2.1.110`, `2.1.111`, `2.1.112`, `2.1.113`, `2.1.114`, `2.1.116`, `2.1.117`, `2.1.118`, `2.1.119`, `2.1.120`, `2.1.121`, `2.1.122`, `2.1.123`, `2.1.126`, `2.1.128`, `2.1.129`, `2.1.131`, `2.1.132`, `2.1.133`, `2.1.136`, `2.1.137`, and `2.1.138` are published and were re-verified.

`patch-thinking.js` now also registers `2.1.113`, `2.1.114`, `2.1.116`, `2.1.117`, `2.1.118`, `2.1.119`, `2.1.120`, `2.1.121`, `2.1.122`, `2.1.123`, `2.1.126`, `2.1.128`, `2.1.129`, `2.1.130`, `2.1.131`, `2.1.132`, `2.1.133`, `2.1.136`, `2.1.137`, and `2.1.138` for native/binary targets, reusing the same tweakcc-style memoized call-site regex family as `2.1.112`. Starting in `2.1.113`, the npm package is a wrapper whose `postinstall` copies the platform native binary into `bin/claude.exe`, so the patchers also auto-detect that npm/local binary path. `2.1.122`, `2.1.123`, `2.1.126`, `2.1.128`, `2.1.129`, `2.1.131`, `2.1.132`, `2.1.133`, and `2.1.136`-`2.1.138` keep the same `if(!D&&!A)return null`/`if(!J&&!A)return null` gate family for both `thinking` and `redacted_thinking`; `2.1.136`-`2.1.138` were verified on the darwin-arm64 native package with one matching embedded renderer bundle each. `2.1.102`, `2.1.103`, `2.1.106`, and `2.1.130` remain inferred support only because Anthropic did not publish npm tarballs for direct validation.
...
**Re-verified on 2.1.80 / 2.1.83 / 2.1.84 / 2.1.85 / 2.1.86 / 2.1.87 / 2.1.88 / 2.1.89 / 2.1.90 / 2.1.91 / 2.1.92 / 2.1.94 / 2.1.96 / 2.1.97 / 2.1.98 / 2.1.101 / 2.1.104 / 2.1.105 / 2.1.107 / 2.1.108 / 2.1.109 / 2.1.110 / 2.1.111 / 2.1.112 / 2.1.113 / 2.1.114 / 2.1.116 / 2.1.117 / 2.1.118 / 2.1.119 / 2.1.120 / 2.1.121 / 2.1.122 / 2.1.123 / 2.1.126 / 2.1.128 / 2.1.129 / 2.1.131 / 2.1.132 / 2.1.133 / 2.1.136 / 2.1.137 / 2.1.138:** the waiting-state UI still renders `taskDescription` verbatim inside `renderToolUseProgressMessage(...)`, so removing just that description element is enough to keep the view compact. The script now scans all duplicate native renderer blocks; the actual task output, task state, and completion notifications are unchanged.
