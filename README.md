...
**npm availability note (2026-04-17):** `@anthropic-ai/claude-code@2.1.43`, `2.1.46`, `2.1.57`, `2.1.60`, `2.1.65`, `2.1.102`, `2.1.103`, and `2.1.106` are not published on npm (`ETARGET`/`E404`). `2.1.64`, `2.1.66`, `2.1.67`, `2.1.68`, `2.1.69`, `2.1.70`, `2.1.71`, `2.1.72`, `2.1.73`, `2.1.74`, `2.1.75`, `2.1.76`, `2.1.77`, `2.1.78`, `2.1.79`, `2.1.80`, `2.1.81`, `2.1.83`, `2.1.84`, `2.1.85`, `2.1.86`, `2.1.87`, `2.1.88`, `2.1.89`, `2.1.90`, `2.1.91`, `2.1.92`, `2.1.94`, `2.1.96`, `2.1.97`, `2.1.98`, `2.1.101`, `2.1.104`, `2.1.105`, `2.1.107`, `2.1.108`, `2.1.109`, `2.1.110`, `2.1.111`, and `2.1.112` are published and were re-verified.

`patch-thinking.js` now also registers `2.1.111` and `2.1.112` for both npm/local and native/binary targets, reusing the same tweakcc-style regex family as `2.1.110`. `2.1.102`, `2.1.103`, and `2.1.106` remain inferred support only because Anthropic did not publish npm tarballs for direct validation.
...
**Re-verified on 2.1.80 / 2.1.83 / 2.1.84 / 2.1.85 / 2.1.86 / 2.1.87 / 2.1.88 / 2.1.89 / 2.1.90 / 2.1.91 / 2.1.92 / 2.1.94 / 2.1.96 / 2.1.97 / 2.1.98 / 2.1.101 / 2.1.104 / 2.1.105 / 2.1.107 / 2.1.108 / 2.1.109 / 2.1.110 / 2.1.111 / 2.1.112:** the waiting-state UI still renders `taskDescription` verbatim inside `renderToolUseProgressMessage(...)`, so removing just that description element is enough to keep the view compact. The actual task output, task state, and completion notifications are unchanged.
