...
**Current Version:** Claude Code 2.1.185 (Updated 2026-06-22)
...
**npm availability note (updated 2026-06-22):** `@anthropic-ai/claude-code@2.1.43`, `2.1.46`, `2.1.57`, `2.1.60`, `2.1.65`, `2.1.102`, `2.1.103`, `2.1.106`, `2.1.130`, `2.1.155`, `2.1.164`, `2.1.171`, `2.1.180`, and `2.1.184` are not published on npm (`ETARGET`/`E404`). `2.1.154`, `2.1.156`, `2.1.157`, `2.1.158`, `2.1.160` through `2.1.163`, `2.1.165` through `2.1.170`, `2.1.172` through `2.1.179`, `2.1.181`, `2.1.182`, `2.1.183`, and `2.1.185` are published and were re-verified. `@anthropic-ai/claude-code-linux-x64@2.1.156` returned `ETARGET` during earlier research, while `@anthropic-ai/claude-code-darwin-arm64@2.1.156` was published and verified. For `2.1.157`, `2.1.158`, `2.1.160` through `2.1.163`, `2.1.165` through `2.1.170`, `2.1.172` through `2.1.179`, `2.1.181`, `2.1.182`, `2.1.183`, and `2.1.185`, both `@anthropic-ai/claude-code-darwin-arm64` and `@anthropic-ai/claude-code-linux-x64` are published and were dry-run verified.

`patch-thinking.js` now also registers `2.1.154` through `2.1.158`, plus `2.1.160` through `2.1.163`, `2.1.165` through `2.1.170`, `2.1.172` through `2.1.179`, `2.1.181`, `2.1.182`, `2.1.183`, and `2.1.185`, for native/binary targets. `2.1.165` reuses the same tweakcc-style memoized call-site regex family as `2.1.163`; `2.1.166` through `2.1.170`, `2.1.172` through `2.1.179`, `2.1.181`, `2.1.182`, `2.1.183`, and `2.1.185` use the newer memoized call-site shape where `hideInTranscript` is no longer passed, so the patch removes the gates and forces `isTranscriptMode:!0` without trying to patch `hideInTranscript`. Starting in `2.1.113`, the npm package is a wrapper whose `postinstall` copies or hardlinks the platform native binary into `bin/claude.exe`, so the patchers also auto-detect that npm/local binary path. `2.1.154`, `2.1.156`, `2.1.157`, `2.1.158`, `2.1.160` through `2.1.163`, `2.1.165` through `2.1.170`, `2.1.172` through `2.1.179`, `2.1.181`, `2.1.182`, `2.1.183`, and `2.1.185` were verified on darwin-arm64 native binaries, linux-x64 native binaries, and actual npm-wrapper install targets. `2.1.155` remains inferred support only because Anthropic did not publish npm tarballs for direct validation; `2.1.164`, `2.1.171`, `2.1.180`, and `2.1.184` are not registered because no npm wrapper/native tarballs are published.
...
**Re-verified on 2.1.69 / 2.1.70 / 2.1.71 / 2.1.72 / 2.1.73 / 2.1.74 / 2.1.75 / 2.1.76 / 2.1.77 / 2.1.78 / 2.1.79 / 2.1.80 / 2.1.83 / 2.1.84 / 2.1.85 / 2.1.86 / 2.1.87 / 2.1.88 / 2.1.89 / 2.1.90 / 2.1.91 / 2.1.92 / 2.1.94 / 2.1.96 / 2.1.97 / 2.1.98 / 2.1.101 / 2.1.104 / 2.1.105 / 2.1.107 / 2.1.108 / 2.1.109 / 2.1.110 / 2.1.111 / 2.1.112 / 2.1.113 / 2.1.114 / 2.1.116 / 2.1.117 / 2.1.118 / 2.1.119 / 2.1.120 / 2.1.121 / 2.1.122 / 2.1.123 / 2.1.126 / 2.1.128 / 2.1.129 / 2.1.131 / 2.1.132 / 2.1.133 / 2.1.136 / 2.1.137 / 2.1.138 / 2.1.139 / 2.1.140 / 2.1.141 / 2.1.142 / 2.1.143 / 2.1.144 / 2.1.145 / 2.1.146 / 2.1.147 / 2.1.148 / 2.1.149 / 2.1.150 / 2.1.152 / 2.1.153 / 2.1.154 / 2.1.156 / 2.1.157 / 2.1.158 / 2.1.160 / 2.1.161 / 2.1.162 / 2.1.163 / 2.1.165 / 2.1.166 / 2.1.167 / 2.1.168 / 2.1.169 / 2.1.170 / 2.1.172 / 2.1.173 / 2.1.174 / 2.1.175 / 2.1.176 / 2.1.177 / 2.1.178 / 2.1.179 / 2.1.181 / 2.1.182 / 2.1.183 / 2.1.185:** through `2.1.161`, the npm/native build used `key:"npm-deprecation-warning"`, so the existing patch strategy stayed valid. In `2.1.162`, `2.1.163`, `2.1.165` through `2.1.170`, `2.1.172` through `2.1.179`, `2.1.181`, `2.1.182`, `2.1.183`, and `2.1.185`, that warning is already absent from the wrapper-installed, darwin-arm64, and linux-x64 native targets; the patcher therefore returns `Already patched (npm deprecation warning not found)`. `2.1.184` was not published on npm at verification time.
...
**Re-verified on 2.1.80 / 2.1.83 / 2.1.84 / 2.1.85 / 2.1.86 / 2.1.87 / 2.1.88 / 2.1.89 / 2.1.90 / 2.1.91 / 2.1.92 / 2.1.94 / 2.1.96 / 2.1.97 / 2.1.98 / 2.1.101 / 2.1.104 / 2.1.105 / 2.1.107 / 2.1.108 / 2.1.109 / 2.1.110 / 2.1.111 / 2.1.112 / 2.1.113 / 2.1.114 / 2.1.116 / 2.1.117 / 2.1.118 / 2.1.119 / 2.1.120 / 2.1.121 / 2.1.122 / 2.1.123 / 2.1.126 / 2.1.128 / 2.1.129 / 2.1.131 / 2.1.132 / 2.1.133 / 2.1.136 / 2.1.137 / 2.1.138 / 2.1.139 / 2.1.140 / 2.1.141 / 2.1.142 / 2.1.143 / 2.1.144 / 2.1.145 / 2.1.146 / 2.1.147 / 2.1.148 / 2.1.149 / 2.1.150 / 2.1.152 / 2.1.153 / 2.1.154 / 2.1.156 / 2.1.157 / 2.1.158 / 2.1.160 / 2.1.161 / 2.1.162 / 2.1.163 / 2.1.165 / 2.1.166 / 2.1.167 / 2.1.168 / 2.1.169 / 2.1.170 / 2.1.172 / 2.1.173 / 2.1.174 / 2.1.175 / 2.1.176 / 2.1.177 / 2.1.178 / 2.1.179 / 2.1.181 / 2.1.182 / 2.1.183 / 2.1.185:** the waiting-state UI still renders `taskDescription` verbatim inside `renderToolUseProgressMessage(...)`, so removing just that description element is enough to keep the view compact. The script scans all duplicate native renderer blocks; the actual task output, task state, and completion notifications are unchanged. `2.1.184` was not published on npm at verification time.
