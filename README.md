...
**Re-verified on 2.1.80 / 2.1.83 / 2.1.84 / 2.1.85 / 2.1.86 / 2.1.87 / 2.1.88 / 2.1.89 / 2.1.90 / 2.1.91 / 2.1.92 / 2.1.94 / 2.1.96 / 2.1.97 / 2.1.98 / 2.1.101 / 2.1.104 / 2.1.105 / 2.1.107 / 2.1.108 / 2.1.109:** the waiting-state UI still renders `taskDescription` verbatim inside `renderToolUseProgressMessage(...)`, so removing just that description element is enough to keep the view compact. The actual task output, task state, and completion notifications are unchanged.
